...
<h2 style='margin-top:.1em'>PDF/Deep Search</h2>
<div style='text-align:center'>				
    <form name="form1" method="get" action="http://www.google.com/u/uiuclib" class="search">
    <input type="hidden" name="hq" value="inurl:uasfa">
	<input type="text" size="25" name="q" class="searchinput" style='border:solid 1px #ddd'>
